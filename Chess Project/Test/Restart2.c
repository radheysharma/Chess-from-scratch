#include <stdio.h>
#include <math.h>
int board[8][8],undoboard[8][8],castle[2][2],undocastle[2][2],king[2],undoking[2],enpassant[2][8],undoenpassant[2][8],posmov[32][2];
int turn,prmte,undoprmte,stalemate,move50,undomove50,side;
void reset()
{
    for(int i=7;i>-1;i--)
    {
